...
- (void)textDidBeginEditing:(NSNotification *)notification {
    ...
    if ([self.xq_delegate respondsToSelector:@selector(textField:textDidBeginEditing:)]) {
...
- (void)textDidEndEditing:(NSNotification *)notification {
    ...
    if ([self.xq_delegate respondsToSelector:@selector(textField:textDidEndEditing:)]) {
...
- (void)textDidChange:(NSNotification *)notification {
    ...
    if ([self.xq_delegate respondsToSelector:@selector(textField:textDidChange:)]) {
